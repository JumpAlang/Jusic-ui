                        ...
                        <mu-col span="12">
                            <mu-data-table style="background-color: transparent" :selectable="false" :hover="false"
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <td class="is-left">
				    <a class="search_pick_btn" @click="goodMusic(scope.row)" v-if="scope.$index!=0 && good">点赞</a>
				    {{isRoot||isAdmin? scope.row.name + `[${scope.row.id}]`:
                                        scope.row.name}}
                                    </td>
				...
				<mu-radio :value="'mg'" v-model="sourceChat"  color="primary" :label="'咪咕'"></mu-radio>
                        ...
                        <mu-col style="margin-bottom: 160px; ">
                            <div style="padding: 10px 0">
                                ...
                                <br/>
				 <p>如点错歌曲可以输入 “<span style="color: #009688;">删除音乐 歌名</span>” 即可删除歌曲。 </p>
				<br/>
